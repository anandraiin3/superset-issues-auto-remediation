...
class OrchestratorTestCase(unittest.TestCase):
    ...
    def test_successful_remediation(
        ...
        remediate_issue(
            "https://github.com/test/repo", 1, "XSS bug", "details"
        )
    ...
    def test_idempotency_skips_duplicate(
        ...
        remediate_issue("https://github.com/test/repo", 50, "Bug", "body")
    ...
    def test_expired_session_marked_failed(
        ...
        remediate_issue("https://github.com/test/repo", 60, "Bug", "body")
        mock_poll.assert_called_once()
